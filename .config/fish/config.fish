...
# word-wise movement (stops at spaces/punctuation)
bind ctrl-right nextd-or-forward-word
bind ctrl-left prevd-or-backward-word
# token-wise movement (stops at path/URL segments too, e.g. within /foo/bar)
bind alt-right forward-token
bind alt-left backward-token
# word-wise deletion, matches ctrl-left/right above
bind ctrl-backspace backward-kill-word
bind ctrl-delete kill-word
# token-wise deletion, matches alt-left/right above
